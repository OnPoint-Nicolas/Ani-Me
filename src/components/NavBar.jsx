...
const NavBar = () => {
  ...
  return (
    <nav className="absolute w-full top-0 z-50 flex items-center justify-between border-b border-white/10 bg-anime-surface/80 px-4 py-2 shadow-2xl shadow-black/20 backdrop-blur-xl supports-[backdrop-filter]:bg-anime-surface/65">
